...
import { Sparkles, Wand2, Search, TrendingUp, Zap, Target } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12 space-y-6">
          <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full glass mb-4">
            ...
            <span className="text-sm font-medium text-white/80">AI-Powered Business Naming</span>
          </div>
          
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            <span className="gradient-text">SmartName AI</span>
          </h1>
          
          <p className="text-xl text-white/70 max-w-2xl mx-auto leading-relaxed">
            Generate unique, memorable business names instantly with our AI-powered tool. 
            Perfect for startups, brands, and entrepreneurs.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-8 mt-8">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white/60">50+ Industries</span>
            </div>
            <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white/60">AI-Optimized</span>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-12">
          <div className="card-gradient p-8 space-y-6">
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center space-x-2">
              ...
              <span>Generate Your Business Name</span>
            </h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Textarea
                  placeholder="Describe your business (e.g., 'A modern fitness app that connects people with personal trainers')"
                  value={description}
              ...
              <div>
                ...
                <Input
                  placeholder="Enter keywords separated by commas (e.g., fast, reliable, smart)"
                  value={keywords}
        ...
        {generatedNames.length === 0 && !isGenerating && (
          <div className="max-w-2xl mx-auto text-center">
            <div className="card-glass p-12">
              <Sparkles className="w-16 h-16 text-brand-primary mx-auto mb-4 floating" />
              <h3 className="text-xl font-semibold text-white mb-2">
                Ready to Find Your Perfect Business Name?
              </h3>
              <p className="text-white/60">
                Describe your business above and let our AI create amazing name suggestions for you!
              </p>
            </div>
          </div>
        )}
